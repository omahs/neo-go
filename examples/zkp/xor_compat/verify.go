// Package xor_compat contains an example of smart contract that uses BLS12-381
...
//
// This example is constructed to proof that a&b=0 where a and b are private input.
//
